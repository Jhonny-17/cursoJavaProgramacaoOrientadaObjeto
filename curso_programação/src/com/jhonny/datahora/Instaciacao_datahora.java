...
public class Instaciacao_datahora {
	...
	public static void main(String[] args) {
		...
		LocalDate d010 = LocalDate.of(2022, 7, 20);
		LocalDateTime d011 = LocalDateTime.of(2022, 7, 20, 1, 30);
		...
		System.out.println("d010 = " + d010.toString());
